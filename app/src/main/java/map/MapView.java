...
/**
 * Basic data about a map image view. Immutable. Lon(gitude) and
 * lat(itude) are the center-point (in degrees).
 * (Web-)Mercator-projection. (0,0) is equator around Africa.
 * Lon grows west, lat grows north.
 *
 * @inv -180 <= lon < 180
